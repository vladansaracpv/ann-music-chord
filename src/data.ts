...
const CHORD_LIST: string[][] = [
  ...
  // ==Legacy==
  ['1P 2M 4P 5P', 'sus24', 'sus24 sus4add9'],
  ['1P 3M 13m', 'Mb6', 'Mb6'],
  ['1P 3M 5A 7M 9M', 'Maj9#5', 'maj9#5 Maj9#5'],
  ['1P 3M 5A 7m', '7#5', '7#5 +7 7aug aug7'],
  ['1P 3M 5A 7m 9A', '7#5#9', '7#5#9 7alt 7#5#9_ 7#9b13_'],
  ['1P 3M 5A 7m 9M', '9#5', '9#5 9+'],
  ['1P 3M 5A 7m 9M 11A', '9#5#11', '9#5#11'],
  ['1P 3M 5A 7m 9m', '7#5b9', '7#5b9'],
  ['1P 3M 5A 7m 9m 11A', '7#5b9#11', '7#5b9#11'],
  ['1P 3M 5A 9A', '+add#9', '+add#9'],
  ['1P 3M 5A 9M', 'M#5add9', 'M#5add9 +add9'],
  ['1P 3M 5P 6M 11A', 'M6#11', 'M6#11 M6b5 6#11 6b5'],
  ['1P 3M 5P 6M 7M 9M', 'M7add13', 'M7add13'],
  ['1P 3M 5P 6M 9M 11A', '69#11', '69#11'],
  ['1P 3M 5P 6m 7m', '', '7b6'],
